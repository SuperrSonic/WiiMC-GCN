...
{
return;
//	Yltexture = (u8*)memalign(32, 1024*MAX_HEIGHT);
//	Yrtexture = (u8*)memalign(32, (MAX_WIDTH-1024)*MAX_HEIGHT);
//	Utexture = (u8*)memalign(32, 1024*(MAX_HEIGHT/2));
//	Vtexture = (u8*)memalign(32, 1024*(MAX_HEIGHT/2));        
}
